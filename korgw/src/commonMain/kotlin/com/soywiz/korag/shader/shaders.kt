...
open class Shader(val type: ShaderType, val stm: Program.Stm , val glsl: String) {
    private val stmHashCode = stm.hashCode()
    var glslString = glsl
    private val cachedHashCode = (type.hashCode() * 31) + stmHashCode * 17 + glslString.hashCode()
